...
export function Dashboard() {
  ...
  return <div className="space-y-7">
    <section><Badge tone="indigo">TON ESPACE DE PRÉPARATION</Badge><h1 className="mt-3 text-3xl font-extrabold tracking-tight sm:text-4xl">Bonjour Hamza Jellam👋</h1><p className="mt-2 max-w-2xl text-slate-500">Organise tes cours EPS, suis ta progression et prépare ton concours efficacement.</p></section>
